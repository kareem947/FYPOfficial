...
public class ShowHistory extends AppCompatActivity implements OnMapReadyCallback , TaskLoadedCallback {
    ...
    TextView pickupLocationtxt,dropOffLocationtxt,driverNametxt,driverMobiletxt,datetxt,rcvrNametxt,rcvrMobiletxt,customerNametxt,customerMobiletxt;
