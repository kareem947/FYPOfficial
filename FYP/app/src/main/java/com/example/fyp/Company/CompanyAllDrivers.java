...
public class CompanyAllDrivers extends Fragment {

    RecyclerView recyclerView;
    ArrayList<CompanyAllCustomersModel> list;

    public CompanyAllDrivers() {
    ...
    public void getUnregiteredDrivers(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                CompanyAllDriversAdapter requestsAdapter=new CompanyAllDriversAdapter(getContext(),list);
