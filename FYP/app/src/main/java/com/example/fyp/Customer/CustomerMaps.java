...
Toolbar toolbar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return super.onCreateView(inflater, container, savedInstanceState);
        ...
        DatabaseReference workingDrivers= FirebaseDatabase.getInstance().getReference().child("WorkingRequests").child(uid);
                ...
                if (dataSnapshot.exists()){
                    /*for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()) {
                       // String id=dataSnapshot1.getKey();
                        String id=dataSnapshot.

                        Log.d("cheking12",id);
                        addMarkers(id);
                    }*/
                    String id=dataSnapshot.child("driverId").getValue(String.class);
                    addMarkers(id);
                }
                }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                 ...
                 //   makeroute();
                    ...
                    DatabaseReference customerId = FirebaseDatabase.getInstance().getReference().child("WorkingRequests").child(uid);
